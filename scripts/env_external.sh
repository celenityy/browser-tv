...
# Gradle flags
GRADLE_FLAGS="${BROWSER_TV_GRADLE_FLAGS}"
export GRADLE_FLAGS

# Rust flags
CARGO_BUILD_RUSTDOCFLAGS="${BROWSER_TV_RUST_FLAGS}"
RUSTDOCFLAGS="${BROWSER_TV_RUST_FLAGS}"
...
# Java home
JAVA_HOME="${BROWSER_TV_JAVA_HOME}"
export JAVA_HOME
...
readonly PHOENIX_PYTHON_DIR="${BROWSER_TV_PYTHON_DIR}"
readonly PHOENIX_SED="${BROWSER_TV_SED}"
readonly PHOENIX_SPECS=0
readonly PHOENIX_TAR="${BROWSER_TV_TAR}"
readonly PHOENIX_UV_CACHE="${BROWSER_TV_UV_CACHE}"
readonly PHOENIX_UV_DIR="${BROWSER_TV_UV_DIR}"
readonly PHOENIX_UV_LOCAL="${BROWSER_TV_UV_LOCAL}"
readonly PHOENIX_UV_PYTHON="${BROWSER_TV_UV_PYTHON}"
readonly PHOENIX_UV_TOOLS="${BROWSER_TV_UV_TOOLS}"
