...
# cbindgen
readonly BROWSER_TV_CBINDGEN_DEFAULT="${BROWSER_TV_EXTERNAL}/cbindgen"
if [[ -z "${BROWSER_TV_CBINDGEN+x}" ]]; then
    BROWSER_TV_CBINDGEN="${BROWSER_TV_CBINDGEN_DEFAULT}"
fi
readonly BROWSER_TV_CBINDGEN
export BROWSER_TV_CBINDGEN
