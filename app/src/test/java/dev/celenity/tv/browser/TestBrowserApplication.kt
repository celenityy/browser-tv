...
import dev.celenity.tv.browser.helpers.EngineVariantFunctionality

/**
 * The application class used by the [BrowserRobolectricTestRunner]: this class may modified to run additional
 * test setup code during off-device Robolectric tests.
 *
 * This class should not be confused with [BrowserTestApplication] which is used for on-device tests.
 * Unfortunately, this class name is hardcoded into the [BrowserRobolectricTestRunner] so we can't rename it to
