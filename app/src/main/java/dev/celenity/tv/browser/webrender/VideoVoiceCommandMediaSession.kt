...
import dev.celenity.tv.browser.webrender.VideoVoiceCommandMediaSession.MediaSessionCallbacks
import dev.celenity.tv.browser.ext.addJavascriptInterface
import dev.celenity.tv.browser.ext.observePlaybackState
import dev.celenity.tv.browser.ext.pauseAllVideoPlaybacks
import dev.celenity.tv.browser.ext.pauseTargetVideo
import dev.celenity.tv.browser.ext.playTargetVideo
import dev.celenity.tv.browser.ext.removeJavascriptInterface
import dev.celenity.tv.browser.ext.seekTargetVideoToPosition
import java.util.concurrent.TimeUnit
import kotlin.math.roundToLong

private const val JS_INTERFACE_IDENTIFIER = "_browserTV_playbackStateObserverJava"
private const val MEDIA_SESSION_TAG = "BrowserTVMedia"
 ...
 *
 * For simplicity, we keep our MediaSession active (buffering, playing, paused) while Browser is
