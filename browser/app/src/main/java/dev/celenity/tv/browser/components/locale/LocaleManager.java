...
package dev.celenity.tv.browser.components.locale;
...
import dev.celenity.tv.browser.generated.LocaleList;
...
public class LocaleManager {
     ...
     *
     * If the user has not explicitly chosen a Browser-specific locale, we say
     * we are "mirroring" the system locale.
     *
     * When we are not mirroring, system locale changes do not impact Browser
     ...
     *
     * By contrast, when we are mirroring, system locale changes cause Browser
