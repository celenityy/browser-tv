...
import dev.celenity.tv.browser.widget.IgnoreFocusMovementMethod
        ...
        val eventDisposable = toolbarViewModel.events.subscribe {
            it?.consume {
                when (it) {
                    ...
                    ToolbarViewModel.Action.ExitBrowser -> exitBrowser()
                }
                true
            }
        }
    ...
    private inner class ToolbarOnClickListener : View.OnClickListener {
        override fun onClick(view: View?) {
            ...
            when (event) {
                ...
                NavigationEvent.EXIT_BROWSER -> toolbarViewModel.exitBrowserButtonClicked()
