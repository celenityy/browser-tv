...
package dev.celenity.tv.browser.search

import android.app.Application
import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.launch
import mozilla.components.browser.search.SearchEngineManager
import dev.celenity.tv.browser.search.SearchEngineManagerFactory.AMAZON_SEARCH_CODE
import dev.celenity.tv.browser.search.SearchEngineManagerFactory.AMAZON_SEARCH_CODE_US_ONLY
