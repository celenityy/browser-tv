...
import dev.celenity.tv.browser.TestDependencyProvider.serviceLocator
 ...
 *
 * This class should not be confused with [BrowserApplication] which is used for off-device Robolectric tests.
 */
class BrowserOnDeviceTestApplication : BrowserApplication() {
 ...
 *
 * [BrowserOnDeviceTestApplication.createServiceLocator] checks here for a custom
 ...
 * [BrowserOnDeviceTestRunner] for it to be used.
 *
 ...
 * Should this requirement change, update code in [BrowserOnDeviceTestRunner]. *Do not
