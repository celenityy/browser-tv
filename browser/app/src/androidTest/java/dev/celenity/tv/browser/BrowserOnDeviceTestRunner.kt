 ...
 */
class BrowserOnDeviceTestRunner : AndroidJUnitRunner() {

    private lateinit var app: Application
    private lateinit var classLoader: ClassLoader

    override fun newApplication(cl: ClassLoader?, className: String?, context: Context?): Application {
        return super.newApplication(cl, BrowserOnDeviceTestApplication::class.java.name, context).also {
            app = it
            classLoader = cl!!
        }
    }
...
private fun Bundle.extractClass(): String? {
    ...
    // e.g., dev.celenity.tv.browser.ui.PocketBasicUserFlowTest#pocketBasicUserFlowTest
